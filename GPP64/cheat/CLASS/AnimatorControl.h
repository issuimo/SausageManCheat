...
struct AnimatorControl : II::MonoBehaviour {
	...
	UnityResolve::UnityType::Transform* AIXCCOffset;
	...
	char parachuteRenderers[0x000004];
	...
	bool ThrowGrenade;
	bool _isDance;
	char _isDance_[0x000001];
	char preAnimatorState[0x000004];
	bool weaponReleased;
	char weaponReleased_[0x000003];
	...
	bool lastIsReleaseGandaBurn;
	char lastIsReleaseGandaBurn_[0x000001];
	float checkRagDollTime;
	float bigHeadTimer;
	float bigHeadAllTime;
	float bigHeadScale;
	char isBigHead[0x000004];
};