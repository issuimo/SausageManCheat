...
#define __ERROR(x) LOG_ERROR(std::format("address:{} | code:{} | info:{} |->{}\n", (void*)GetExceptionInformation()->ExceptionRecord->ExceptionAddress, (int)GetExceptionInformation()->ExceptionRecord->ExceptionCode, (const char*)GetExceptionInformation()->ExceptionRecord->ExceptionInformation, x));
